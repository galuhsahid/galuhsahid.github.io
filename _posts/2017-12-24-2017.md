...
date:   2017-12-24
tags: [personal]
featured-img: "/images/posts/2017/featured.jpeg"
---
...
<figure class="figure">
    <img class="figure-image" src="{{ site.url }}/images/posts/2017/icacsis.jpg" alt="A picture of me presenting a paper I co-authored in ICACSIS.">
    <figcaption class="figcaption">
        <span class="figcaption__text"><a href="http://twitter.com/puputivn">Photo credit</a>.</span>
    </figcaption>
</figure>
...
<figure class="figure">
    <img class="figure-image" src="{{ site.url }}/images/posts/2017/pycon.jpg" alt="A picture of me presenting my talk in PyCon ID.">
    <figcaption class="figcaption">
        <span class="figcaption__text">So nervous I didn't have time to do my hair. 😀 <a href="http://twitter.com/dvigneshwer">Photo credit</a>.</span>
    </figcaption>
</figure>
...
<figure class="figure">
    <img class="figure-image" src="{{ site.url }}/images/posts/2017/bali.jpg" alt="A picture of my laptop with VS code open, taken in Bali.">
    <figcaption class="figcaption">
        <span class="figcaption__text">I'm so glad my sister's into (film) photography now, I no longer am the family photographer and I can get my pictures taken! Yay!</span>
    </figcaption>
</figure>
...
<figure class="figure">
    <img class="figure-image" src="{{ site.url }}/images/posts/2017/bandung.jpg" alt="A coffee shop in Bandung.">
    <figcaption class="figcaption">
        <span class="figcaption__text">A coffee shop in Bandung; coffee is important to all of us!</span>
    </figcaption>
</figure>

<figure class="figure">
    <img class="figure-image" src="{{ site.url }}/images/posts/2017/museum.jpg" alt="A picture of Museum Geologi in Bandung.">
    <figcaption class="figcaption">
        <span class="figcaption__text">Museum Geologi in Bandung is the only museum I visited this year...</span>
    </figcaption>
</figure>
...
<figure class="figure">
    <img class="figure-image" src="{{ site.url }}/images/posts/2017/inner-mongolia.jpg" alt="A picture of the sunrise in Inner Mongolia grassland.">
    <figcaption class="figcaption">
        <span class="figcaption__text">Inner Mongolia grassland kind of morning.</span>
    </figcaption>
</figure>
...
<figure class="figure">
    <img class="figure-image" src="{{ site.url }}/images/posts/2017/inner-mongolia-broke.jpg" alt="A picture of me taking pictures in Inner Mongolia.">
    <figcaption class="figcaption">
        <span class="figcaption__text">Super broke. Met fellow travelers/photographers (and I got tons of photography advices!) and it turned out to be a great day for photo-hunting--which, of course, you can do for free.</span>
    </figcaption>
</figure>
...
<figure class="figure">
    <img class="figure-image" src="https://github.com/galuhsahid/galuhsahid.github.io/blob/master/assets/images/IMG_0882.JPG?raw=true" alt="Me and my book titled Whiplash.">
    <figcaption class="figcaption">
        <span class="figcaption__text">I'm so glad my sister's into (film) photography now, I no longer am the family photographer and I can get my pictures taken! Yay!</span>
    </figcaption>
</figure>
...
<figure class="figure">
    <img class="figure-image" src="{{ site.url }}/images/posts/2017/sketch.jpg" alt="A picture of a sketch of an entrance to a temple near Danau Bedugul.">
    <figcaption class="figcaption">
        <span class="figcaption__text">A sketch of an entrance to a temple near Danau Bedugul.</span>
    </figcaption>
</figure>
